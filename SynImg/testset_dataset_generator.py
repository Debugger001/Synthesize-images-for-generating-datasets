...
gray_value = 1
dir_list = tuple(open('/home/lc/fyj/obj/dir_list.txt', 'r'))
...
def create_image_anno(objects, distractor_objects, img_file, semantic_file, instance_file, anno_file, w=WIDTH, h=HEIGHT, scale_augment=False, rotation_augment=False, blending_list=['none'], dontocclude=True):
    ...
    generated_files = glob.glob(os.path.join('/home/lc/syndata-generation/testset_output_dir/train', '*.jpg'))
...
def parse_args():
    ...
    parser.add_argument("--root", default = "/home/lc/fyj/obj/",
      help="The root directory which contains the images and annotations.")
    parser.add_argument("--exp", default = "/home/lc/syndata-generation/testset_output_dir/",
